...
@Composable
fun TabsScreen_(tabsClick: () -> Unit, themeViewModel: ThemeViewModel) {
            ...
            Column(
                ...
                Column {
                    ...
                    TabRow(
                        ...
                        tabItems.forEachIndexed { index, tabTitle ->
                            Tab(
                                selected = containerTabIndexEnabled == index, onClick = {
                    ...
                    TabRow(
                        ...
                        tabItems.forEachIndexed { index, tabTitle ->
                            Tab(
                                ...
                                onClick = { selectedTabIndexEnabledWithAssets = index },
                                enabled = true,
                                modifier = Modifier.widthIn(min = tabs_min_width)
                                    .height(height_standard_tab)
                    ...
                    TabRow(
                        ...
                        tabItems.forEachIndexed { index, tabTitle ->
                            Tab(
                                selected = containerTabIndexEnabledWithAssets == index, onClick = {
                                ...
                                modifier = Modifier.widthIn(min = tabs_min_width)
                                    .height(height_container_tab)
                                    .padding(end = sz_spacing_frostbite) then Modifier.border(
                                    width = 1.dp,
                    ...
                    TabRow(
                        ...
                        tabItems.forEachIndexed { index, tabTitle ->
                            Tab(
                                ...
                                modifier = Modifier.widthIn(min = tabs_min_width)
                                    .height(height_container_tab)
                                    .padding(end = sz_spacing_glacial) then Modifier.border(
                                    width = 1.dp,
                                    color = Color.Transparent,
                                    shape = RoundedCornerShape(sz_spacing_quickFreeze)
                                )
                    ...
                    LazyRow(content = {
                        items(tabItemsScrolable.size) { index ->
                            ...
                            Tab(
                                ...
                                selectedContentColor = Color.Transparent,
                                modifier = Modifier.padding(end = sz_spacing_glacial) then Modifier.border(
                                    width = 1.dp,
                    ...
                    ScrollableTabRow(
                        ...
                        tabItemsScrolable.forEachIndexed { index, tabTitle ->
                            Tab(
                                ...
                                onClick = { defaultScrolledTabIndexEnabledWithAssets = index },
                                enabled = true,
                                selectedContentColor = LightColors.primary
                            ) {
                                Box(
